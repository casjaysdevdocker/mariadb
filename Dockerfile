...
ENV HOSTNAME="casjaysdevdocker-mariadb"
...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/mariadb"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/mariadb"
