...
ARG BUILD_DATE="Sat Sep  2 02:59:06 PM EDT 2023"
...
ARG IMAGE_REPO="casjaysdevdocker/mariadb"
...
ARG PACK_LIST="apache2 apache2-ctl apache2-lua apache2-ssl apache2-ldap apache2-icons apache2-http2 \
  ...
  mariadb-server-utils mariadb-client mariadb pwgen \
...
ENV HOSTNAME="casjaysdev-mariadb"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/mariadb" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/mariadb" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/mariadb" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/mariadb" \
